...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-horizontal" action="{{ route('module.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" value="{{old('name')}}" name="name" placeholder="Module Name">
                                    </div>
                                    <div class="col-md-3">
                                        @error('name')
                                        <span class="error">{{ $message }}</span>
